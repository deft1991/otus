 ...
 */
public class CreatePostProfileHandler extends BaseHandler {
    private static final String USERS_PAGE_TEMPLATE = "usersAll.ftl";
    private final DbUserService userService;

    public CreatePostProfileHandler(DbUserService userService, TemplateProcessor templateProcessor) {

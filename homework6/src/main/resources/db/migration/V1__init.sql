...
(
    ...
    CONSTRAINT FK_GENRE_T_BOOK_TO_AUT FOREIGN KEY (GENRE_ID) REFERENCES GENRE (ID)
);
CREATE UNIQUE INDEX BOOK_TO_GENRE_ID_uindex ON BOOK_TO_GENRE (ID);

CREATE TABLE COMMENTERY
(
    ID varchar(36) PRIMARY KEY NOT NULL,
...
CREATE UNIQUE INDEX COMMENTERY_ID_uindex ON COMMENTERY (ID);
ALTER TABLE COMMENTERY COMMENT = 'Коментарий';